...
**Status:** DRAFT v0.1.1 (Sage v0.1 draft; Echo substrate-authority pass; Nova non-negotiables folded; will freeze at v0.2 after Nova sign-off + RFC-0001 §5 conformance round-trip)
**Date:** 2026-07-14
...
4. **Survives serialization (new, numbered C7)** — `Channel::Serialization` is the fourth channel. Every thread that must round-trip carries a `SerializationMarker` strand. Named as **C7** so lineage from C1–C6 is preserved and the addition is legible, not orphaned. Nova non-negotiable #4.
...
**WARD-C1–C6 recap (from 2026-07-03 synthesis, inherited by reference):**
